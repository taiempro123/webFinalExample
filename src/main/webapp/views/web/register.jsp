                ...
                <div id="register-form" class="login-register-form-wrap">
                    ...
                    <div class="row">
                        ...
                        <div class="md-5 col-md-6">
                            ...
                            <input type="text" placeholder="Họ và tên" class="form-control" id="fullname" name="fullname" required>
                        </div>
                        ...
                        <div class="md-5 col-md-6">
                            ...
                            <input type="tel" placeholder="Số điện thoại" class="form-control" name="phone" id="phone" required pattern="[0-9]{10,12}">
                        </div>
                        ...
                        <div class="md-5 col-md-12">
                            ...
                            <input type="text" placeholder="Địa chỉ" id="address" class="form-control" name="address" required>
